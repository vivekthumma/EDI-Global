...
<head>
  ...
  <title>Lead Students Table</title>
    ...
    <div class="modal-dialog">
      <form class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="date" class="form-control mb-2" placeholder="Lead Date" required>
          <input type="text" class="form-control mb-2" placeholder="Sources" required>
        </div>
  ...
  <div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
      <form class="modal-content">
        ...
        <div class="modal-body">
          <input type="text" class="form-control mb-2" value="Amit Singh">
          <input type="text" class="form-control mb-2" value="9876543210">
          <input type="email" class="form-control mb-2" mailto:value="amit@gmail.com">
          <input type="date" class="form-control mb-2" value="2025-04-14">
          <input type="text" class="form-control mb-2" value="Instagram">
        </div>
        <div class="modal-footer">
